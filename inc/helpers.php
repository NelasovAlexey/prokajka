...
function time_ago() {
    ...
    $post_time = get_the_date(get_option('date_format'));
    $pst_tm = strtotime($post_time);
    $time_now = current_time('timestamp');
    $tima_disp = ('Posting') .' '. human_time_diff($pst_tm, $time_now) . ' ' . _('ago');
    return $tima_disp;
}
